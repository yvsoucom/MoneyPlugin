...
<div class="container mx-auto p-6 bg-white dark:bg-gray-900 shadow rounded min-h-screen">
    ...
    <h1 class="text-2xl font-semibold mb-6 text-gray-900 dark:text-gray-100">
        {{ __('MoneyPlugin::menu.Add Currency') }}
    </h1>
    ...
    <form method="POST" action="{{ route('plugins.MoneyPlugin.currencytype.store') }}">
        ...
        <div class="mb-4">
            ...
            <input id="currency_name" name="currency_name" type="text"
                   ...
                   class="w-full border rounded px-3 py-2 bg-white text-gray-900 
                          dark:bg-gray-800 dark:text-gray-100 
                            
                          focus:outline-none focus:ring-2 focus:ring-blue-500
                          @error('currency_name') border-red-500 dark:border-red-400 @enderror">
            @error('currency_name')
            <p id="currency_name_error" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea id="remark" name="remark"
                      class="w-full border border-gray-300 dark:border-gray-600 
                             ...
                             focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('remark') }}</textarea>
        </div>

        <button type="submit"
                class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 
                       dark:bg-blue-500 dark:hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
            Add Currency
        </button>
