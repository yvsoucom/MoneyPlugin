    ...
    <div class="container mx-auto p-6 bg-white dark:bg-gray-900 shadow rounded min-h-screen">
        ...
        <form method="POST" action="{{ route('plugins.MoneyPlugin.prate.store') }}">
            ...
            <div class="mb-4">
                ...
                <input id="rateType" name="rateType" type="text" value="{{ old('rateType') }}"
                    class="w-full border rounded px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 @error('rateType') border-red-500 @enderror">
                @error('rateType')
            ...
            <div class="mb-4">
                ...
                <select id="cashtype" name="cashtype"
                    ...
                    @foreach($currencyTypes as $currencyType)
                        <option value="{{ $currencyType->id }}" {{ old('cashtype') == $currencyType->id ? 'selected' : '' }}>
