...
<div class="container mx-auto p-6 bg-white shadow rounded min-h-screen">
    <h1 class="text-2xl font-semibold mb-6">Add Rate</h1>
    ...
    <form method="POST" action="{{ route('plugins.MoneyPlugin.prate.store') }}">
        ...
        <div class="mb-4">
            ...
            <textarea id="remarks" name="remarks" class="w-full border border-gray-300 rounded px-3 py-2">{{ old('remarks') }}</textarea>
        </div>
