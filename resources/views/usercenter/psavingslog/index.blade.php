    ...
    <table class="min-w-full bg-white border">
        <thead>
            <tr>
                ...
                <th class="border px-4 py-2">Pay</th>
                <th class="border px-4 py-2">Balance New</th>
        ...
        <tbody>
            @foreach ($logs as $log)
                <tr>
                    ...
                    <td class="border px-4 py-2">{{ $log->income }}</td>
                    <td class="border px-4 py-2">{{ $log->pay }}</td>
                    <td class="border px-4 py-2">{{ $log->new }}</td>
